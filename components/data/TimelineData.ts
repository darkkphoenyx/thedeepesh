...
export const timelineData: TimelineItem[] = [
  {
    ...
    description:
      "Integrated Lexical and TipTap editors to enable advanced content editing in ChatBoq, built custom form controls with multi-step workflows, and applied advanced React techniques including component refactoring and cloneElement fixes. Managed global state using Context API and Zustand, collaborated with the PM in weekly stand-ups, and mentored interns on Next.js, Git workflows, and API integration.",
    side: "right",
  },
  {
